...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveRemarkBtn").click(function(){
			...
			//取得添加在文本域中的内容
			/* var noteContent1 = $("#remark").html();
			alert(noteContent1); */
			//虽然textarea是标签对，但是它终归是一个表单元素，我们需要使用val方法操作它的值 
				...
				success : function(data){
					...
					*/
					...
					if(data.success){
						...
						//修改备注成功,需要更新div中的 备注信息，修改时间，修改人
						//更新备注信息
			...
			success : function(data){
				...
				*/
				...
				$.each(data,function(i,n){
					...
					//javascript:void(0); 表示将超链接强制禁用 ，必须以触发事件的形式来触发这个超链接
				...
				//使用before方法，在指定的元素的上方追加新的元素（在下方追加元素使用append）
				$("#remarkDiv").before(html);
		...
		$.ajax({
			...
			success : function(data){
				...
				if(data.success){
					...
					//删除备注成功
					//刷新备注信息列表？ 不行，我们在showRemark方法中使用的追加新元素
					//showRemark();
					
					//我们在执行完删除之后，仅仅只需要删除掉删除的记录所对应的div就可以了
					//找到指定的div，移除该div
					$("#"+id).remove();
	...
	function editRemark(id){
		...
		//为修改操作的模态窗口中提供的隐藏域中的id，赋值
		//总结：在修改页中，或者是在修改操作的模态窗口中，必须要提供一个隐藏域的id
		$("#remarkId").val(id);
	...
	<div style="position: relative; top: 30px; left: 40px;" id="remarkBody">
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				<textarea id="remark" class="form-control" style="width: 850px; resize : none;" rows="2"  placeholder="添加备注123..."></textarea>
